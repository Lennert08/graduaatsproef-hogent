...
\usepackage{pifont} % Voor mooie vinkjes (zonder amssymb conflict)
...
\begin{multicols}{3}
    ...
    % SCREENSHOT (SMS.PNG)
    \begin{center}
        \includegraphics[width=0.95\linewidth]{../gradproef/img/sms.png}
    \end{center}
    ...
    % ITSME LOGO (TIJDELIJK IN COMMENTAAR)
    % Haal het %-teken weg zodra het bestand er is!
    \begin{center}
