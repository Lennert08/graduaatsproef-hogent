...
% De template gebruikt Engelse termen voor de rollen:
...
\begin{multicols}{3}
    ...
    % SCREENSHOT WIZARD
    % Let op: zorg dat sms.png bestaat in gradproef/img/
    \begin{center}
        \includegraphics[width=0.9\linewidth]{../gradproef/img/sms.png}
    \end{center}
    ...
    % ITSME LOGO (Staat even in commentaar tot het bestand gevonden wordt)
    % Haal het %-teken weg als je zeker weet dat het bestand er is!
    \begin{center}
        % \includegraphics[width=0.4\linewidth]{../gradproef/img/itsme_logo.png}
    \end{center}
    ...
    \end{itemize} % HIER WAS DE FOUT (\end{itemize} ipv </itemize>)
