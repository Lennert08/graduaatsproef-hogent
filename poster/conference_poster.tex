...
\usepackage{pifont} % Voor mooie vinkjes zonder conflict

% --- CONFIGURATIE VAN DE KLEURBLOKKEN ---
\newtcolorbox{techbox}[1]{
    colback=hogent-grey!10, 
...
\begin{multicols}{3}
    ...
    \textbf{De Vereisten:}
    \begin{itemize}
        \item[\textcolor{hogent-darkgreen}{\ding{51}}] \textbf{Rechtsgeldig:} Identificatie via 2FA (SMS of Itsme).
        \item[\textcolor{hogent-darkgreen}{\ding{51}}] \textbf{Gebruiksvriendelijk:} Geen externe software nodig.
        \item[\textcolor{hogent-darkgreen}{\ding{51}}] \textbf{Traceerbaar:} Volledige Audit Trail.
    \end{itemize}
    ...
    % SCREENSHOT (SMS.PNG) - VERKLEIND NAAR 0.7
    \begin{center}
        \includegraphics[width=0.4\linewidth]{../gradproef/img/sms.png}
    \end{center}
    ...
    % ITSME LOGO
    % Haal het %-teken hieronder weg als je itsme_logo.png hebt geüpload!
    \begin{center}
